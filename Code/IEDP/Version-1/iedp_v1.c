...
// ==============================================================================================
// Sets the window size for the median filter
    ...
    for (int y = 0; y < height; y++) {
        for (int x = 0; x < width; x++) {
            ...
            if (y == 0 || y == height - 1 || x == 0 || x == width - 1) {
                ...
                output[current_idx]     = input[current_idx];     // Red component
                output[current_idx + 1] = input[current_idx + 1]; // Green component
                output[current_idx + 2] = input[current_idx + 2]; // Blue component
            ...
            for (int dy = -1; dy <= 1; dy++) {
                for (int dx = -1; dx <= 1; dx++) {
                    ...
                    window[idx].r = input[neighbor_idx];     // Red component
                    window[idx].g = input[neighbor_idx + 1]; // Green component
                    window[idx].b = input[neighbor_idx + 2]; // Blue component
...
int main(void) {
    ...
    // Source image
    const char *infile = "iedp.jpg";         
    // Output for filtered RGB image
    const char *filtered_outfile = "iedp_filtered.jpg";
    // Output for greyscale image
    const char *grey_outfile = "iedp_greyscale.jpg";  
    // Output for edge-detected image
    const char *edge_outfile = "iedp_edges.jpg";     
