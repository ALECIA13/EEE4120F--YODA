...
HD_PWD='C:/Users/zolil/Verilog_modules2/Verilog_modules2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_system.tcl
